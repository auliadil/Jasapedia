...
public class AccountActivity extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setSelectedItemId(R.id.account_menu);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
            case R.id.home_menu:
                ...
                break;
            case R.id.add_menu:
                intent = new Intent(AccountActivity.this, AddServiceActivity.class);
                break;
            case R.id.bookings_menu:
                intent = new Intent(AccountActivity.this, BookingsActivity.class);
                break;
